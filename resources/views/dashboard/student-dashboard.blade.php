    ...
    <div class="main-content">
        ...
        <div class="card-body p-md-5 text-black">
                ...
                <label class="form-label" for="name">Full Name</label>
                  <input type="text" id="name" class="form-control form-control-lg" placeholder="Your fullname here"/>
              ...
              <div class="row">
                ...
                <label class="form-label" for="address">Detailed Address</label>
                  <input type="text" id="address" class="form-control form-control-lg" placeholder="e.g. House No:#, Road: "/>
                </div>
                ...
                <label class="form-label" for="class">Name of Institution</label>
                  <input type="text" id="institution" class="form-control form-control-lg" placeholder="Your school / college name"/>
                </div>
                ...
                <label class="form-label" for="phone">Phone Number</label>
                  <input type="text" id="phone" class="form-control form-control-lg" placeholder="01................."/>
