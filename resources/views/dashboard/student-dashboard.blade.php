...
<nav class="navbar">
  <div class="container-fluid std-title">
    <a class="navbar-brand" href="/student-dashboard">Student Dashboard</a>
      ...
      <div class="row">
        <div class="col-md-6 mb-4">
          ...
          <select class="select form-control" name="district">
            <option value="" {{$student_data->district==1 ? 'checked' : ''}}>Select District</option>
        ...
        <div class="col-md-6 mb-4">
          ...
          <select class="select" name="area">
            <option value="1" {{$student_data->area==1 ? 'selected' : ''}}>Area</option>
            <option value="2" {{$student_data->area==2 ? 'selected' : ''}}>Option 1</option>
            <option value="3" {{$student_data->area==3 ? 'selected' : ''}}>Option 2</option>
            <option value="4" {{$student_data->area==4 ? 'selected' : ''}}>Option 3</option>
          </select>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-4">
          ...
          <select class="select" name="class">
            <option value="1" {{$student_data->class==1 ? 'selected' : ''}}>Class</option>
            <option value="2" {{$student_data->class==2 ? 'selected' : ''}}>Class 1</option>
            <option value="3" {{$student_data->class==3 ? 'selected' : ''}}>Class 2</option>
            <option value="4" {{$student_data->class==4 ? 'selected' : ''}}>Class 3</option>
            <option value="5" {{$student_data->class==5 ? 'selected' : ''}}>Class 4</option>
            <option value="6" {{$student_data->class==6 ? 'selected' : ''}}>Class 5</option>
            <option value="7" {{$student_data->class==7 ? 'selected' : ''}}>Class 6</option>
            <option value="8" {{$student_data->class==8 ? 'selected' : ''}}>Class 7</option>
            <option value="9" {{$student_data->class==9 ? 'selected' : ''}}>Class 8</option>
            <option value="10" {{$student_data->class==10 ? 'selected' : ''}}>Class 9</option>
            <option value="11" {{$student_data->class==11 ? 'selected' : ''}}>Class 10</option>
            <option value="12" {{$student_data->class==12 ? 'selected' : ''}}>Class 11</option>
            <option value="13" {{$student_data->class==13 ? 'selected' : ''}}>Class 12</option>
            <option value="14" {{$student_data->class==14 ? 'selected' : ''}}>SSC</option>
            <option value="15" {{$student_data->class==15 ? 'selected' : ''}}>HSC</option>
          </select>
